...
public class adminbooking_info {
    private SimpleStringProperty  Booking_ID, Excursion_Name, Excursion_ID, Port_ID, Booked_Seat, Booked_By, Booked_Date;

    public adminbooking_info(String Booking_ID, String Excursion_Name, String Excursion_ID, String Port_ID,  String Booked_Seat, String Booked_By, String Booked_Date){
